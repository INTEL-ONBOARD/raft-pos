          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              ...
              >
                ...
                {lowCount > 0 && (
                  <span style={{ marginLeft: '8px', fontWeight: 500, color: '#fbbf24' }}>
                    · {lowCount} low stock
                  </span>
                )}
              </p>
              ...
              <div>
                ...
                <p
                  style={{
                    ...
                    lineHeight: 1.2,
                    margin: 0,
                    color: lowCount > 0 ? '#fbbf24' : '#ffffff'
                  }}
                >
                  {lowCount}
                </p>
              ...
              <div>
                ...
                <p
                  style={{
                    ...
                    lineHeight: 1.2,
                    margin: 0,
                    color: outOfStockCount > 0 ? '#dc2626' : '#ffffff'
                  }}
                >
                  {outOfStockCount}
                </p>
          ...
          {lowCount > 0 && (
            ...
            >
              ...
              <p style={{ fontSize: '14px', margin: 0 }}>
                <strong>{lowCount}</strong> product{lowCount !== 1 ? 's are' : ' is'} at or below
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody>
                  {filtered.map((row, idx) => {
                    ...
                    const barColor =
                      row.quantity <= 0 ? '#dc2626' : row.isLowStock ? '#fbbf24' : '#16a34a'
