  ...
  return (
    <div className="modal-overlay fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="modal-panel w-full max-w-[384px] max-h-[90vh] overflow-y-auto overflow-hidden">
        ...
        <div
          className="px-6 py-4 font-mono text-sm print:bg-white print:text-black"
        ...
        >
          ...
          <div className="space-y-0.5">
            <div className="flex justify-between">
              ...
              <span style={{ color: 'var(--text-primary)' }}>
                &#8369;{txn.subtotal.toLocaleString('en-PH', { minimumFractionDigits: 2 })}
              </span>
            </div>
            {txn.discountAmount > 0 && (
              <div className="flex justify-between">
                ...
                <span style={{ color: 'var(--text-primary)' }}>
                  -&#8369;{txn.discountAmount.toLocaleString('en-PH', { minimumFractionDigits: 2 })}
                </span>
              </div>
            )}
            {txn.taxAmount > 0 && (
              <div className="flex justify-between">
                ...
                <span style={{ color: 'var(--text-primary)' }}>
                  &#8369;{txn.taxAmount.toLocaleString('en-PH', { minimumFractionDigits: 2 })}
                </span>
              </div>
            )}
            <div
            ...
            >
              <span>TOTAL</span>
              <span>
                &#8369;{txn.totalAmount.toLocaleString('en-PH', { minimumFractionDigits: 2 })}
              </span>
            </div>
          </div>
          ...
          {txn.change > 0 && (
            <div className="flex justify-between">
              ...
              <span style={{ color: 'var(--text-primary)' }}>
                &#8369;{txn.change.toLocaleString('en-PH', { minimumFractionDigits: 2 })}
              </span>
            </div>
          )}
