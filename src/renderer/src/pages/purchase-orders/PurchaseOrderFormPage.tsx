        ...
        >
            ...
            >
              ...
              <div>
                ...
                <p style={{ fontSize: '12px', color: 'rgba(255,255,255,0.40)', margin: 0 }}>
                  Supplier and general information
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div
              style={{
                padding: '1rem 1.5rem',
                borderBottom: items.length > 0 ? '1px solid rgba(255,255,255,0.07)' : 'none'
              }}
            >
              <div className="relative">
                ...
                {productSearch && filteredProducts.length > 0 && (
                  <div
                    className="absolute top-full left-0 right-0 z-10 mt-1.5 rounded-xl shadow-lg overflow-hidden"
                    ...
                    {items.map((item) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-right">
                          ...
                          >
                            ₱
                            {(item.orderedQty * item.unitCost).toLocaleString('en-PH', {
