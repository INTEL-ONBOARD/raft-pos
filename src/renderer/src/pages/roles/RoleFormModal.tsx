    ...
    <div className="modal-overlay fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="modal-panel w-full max-w-lg max-h-[85vh] flex flex-col overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
          ...
          >
            <p className="text-sm font-semibold mt-4 mb-2" style={{ color: 'var(--text-primary)' }}>
              Permissions
            </p>
            <div className="space-y-1">
              {ALL_PERMISSIONS.map((p) => (
                <label
                  key={p}
                  className="flex items-center gap-2 p-2 rounded-xl cursor-pointer text-sm transition-colors"
