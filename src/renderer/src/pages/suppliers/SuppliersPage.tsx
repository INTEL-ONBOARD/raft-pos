    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            <h1 style={{ fontSize: 20, fontWeight: 700, color: 'rgba(255,255,255,0.92)', lineHeight: 1.2 }}>Suppliers</h1>
      ...
      {/* Content */}
      <div style={{ padding: '0 36px 36px', flex: 1, position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        {deactivateError && (
          <div style={{
            ...
            <button
              ...
              style={{ marginLeft: 8, opacity: 0.7, cursor: 'pointer', fontSize: 16, lineHeight: 1 }}
            >×</button>
          </div>
        )}
        ...
        {query.isLoading ? (
              ...
              <thead>
                <tr>
                  {['Name', 'Contact Person', 'Phone', 'Email', 'Status', ''].map((h, i) => (
                    <th key={h || i} style={i === 5 ? thRightStyle : thStyle}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
          ...
          <div style={{ fontSize: 13, padding: '16px 0', color: '#dc2626' }}>Failed to load suppliers.</div>
        ) : filtered.length === 0 ? (
          <div style={tableContainerStyle}>
            <div style={{
              ...
              <div style={{ textAlign: 'center' }}>
                <p style={{ fontSize: 14, fontWeight: 500, color: 'rgba(255,255,255,0.55)' }}>No suppliers found</p>
              ...
              <tbody>
                {filtered.map(supplier => {
                  ...
                  return (
                    ...
                    >
                      <td style={tdStyle}>
                        <span style={{ fontSize: 13, fontWeight: 500, color: 'rgba(255,255,255,0.85)' }}>{supplier.name}</span>
                      </td>
                      <td style={tdStyle}>
                        <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.45)' }}>{supplier.contactPerson || '—'}</span>
                      </td>
                      <td style={tdStyle}>
                        <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.45)' }}>{supplier.phone || '—'}</span>
                      </td>
                      <td style={tdStyle}>
                        <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.45)' }}>{supplier.email || '—'}</span>
                      </td>
                      <td style={tdStyle}>
